...
c.S3ContentsManager.access_key_id = os.environ['CLOUDCUBE_ACCESS_KEY_ID']
c.S3ContentsManager.secret_access_key = os.environ['CLOUDCUBE_SECRET_ACCESS_KEY']

regex = r"^https:\/\/([a-zA-Z0-9-]+)\.s3\.amazonaws\.com\/([a-zA-Z0-9-]+)$"
[bucket, prefix] = re.search(regex, os.environ['CLOUDCUBE_URL']).groups()
c.S3ContentsManager.bucket = bucket
c.S3ContentsManager.prefix = '{}/jupyter'.format(prefix)
